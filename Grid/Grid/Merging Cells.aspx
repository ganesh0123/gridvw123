...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:demoConnectionString10 %>" SelectCommand="SELECT * FROM [tblEmployee1]"></asp:SqlDataSource>
    </form>
</body>
</html>
